...
class Character: public Entity {
 public:
  ...
  virtual void SpecialMove(double); 
  
  virtual bool GetSpecialMove();
  
  virtual void SetSpecialMove(bool);
  ...
  virtual bool GetCrash();
  
  virtual void SetCrash(bool);
private:
  ...
  bool m_crash; //to check if they ran into an obstical
  bool m_specialMove; //to use their special move
};
#endif
